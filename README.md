...
<table>
  ...
  <tr><td> --projects-filter </td><td>Simple json file of a text array of projects to skip. Supports Ends with matching such as 'Tests.csproj, Tests.vbproj, Tests.fsproj'. <br/><br/> IMPORTANT: By providing <code>default</code> as a parameter to this flag (showcase: <code>--projects-filter default</code>) the defined internal base filter of this tool will be applied! (Located at 'Filters/ProjectFilters.json')</td></tr>
  <tr><td> --packages-filter </td><td>Simple json file of a text array of packages to skip. Or a regular expression defined between two forward slashes <code>'/regex/'</code> or two hashes <code>'#regex#'</code>. <br/><br/> IMPORTANT: By providing <code>default</code> as a parameter to this flag (showcase: <code>--packages-filter default</code>) the defined internal base filter of this tool will be applied! (Located at 'Filters/PackagesFilters.json')</td></tr>
